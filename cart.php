...
<div class="container mb-15">
    <div class="row">
        <div class="col-xl-8 bg-white" style="margin-top: 3rem !important;">
...
// die;  ?>
        ...
        <div class="col-lg-4 mt-10">
                ...
                <table class="table table-order">
                    <tbody>
                        ...
                        <?php $total = !empty($cart['sub_total']) ? number_format($cart['overall_amount'] - $cart['delivery_charge'], 2) : 0 ?>
                                <p class="price "><?= $settings['currency'] . '<span class="final_total"> ' . $total . '</span>'?></p>
                        ...
                        <tr class="total-price">
                            ...
                            <td class="pe-0 text-end">
                                <p class="price text-dark fw-bold"><?= $settings['currency'] . '<span class="final_total"> ' . $total . '</span>' ?></p>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                <a href="<?= base_url('sellers/'. $seller_slug . '/cart/checkout') ?>" id="checkout">
