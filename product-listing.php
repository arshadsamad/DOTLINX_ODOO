            ...
            <nav class="d-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 bg-transparent">
                    ...
                    <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                        <a href="<?= base_url() . 'sellers/' . $seller_slug ?>" class="text-decoration-none"><?= !empty($this->lang->line('seller home')) ? $this->lang->line('seller home') : 'Seller Home' ?></a>
                    <?php } else { ?>
                        <a href="<?= base_url() ?>" class="text-decoration-none"><?= !empty($this->lang->line('home')) ? $this->lang->line('home') : 'Home' ?></a>
                    <?php } ?>
                    </li>

                    <li class="breadcrumb-item active" aria-current="page">
                    <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                        <a href="<?= base_url() . 'sellers/' . $seller_slug . '/products'?>" class="text-decoration-none"><?= !empty($this->lang->line('products')) ? $this->lang->line('products') : 'Products' ?></a>
                    <?php } else { ?>
                        <a href="<?= base_url() . 'products'?>" class="text-decoration-none"><?= !empty($this->lang->line('products')) ? $this->lang->line('products') : 'Products' ?></a>
                    <?php } ?>
                    </li>
                ...
                <div class="col-md-12 order-md-2 <?= (isset($products['filters']) && !empty($products['filters'])) || (isset($categories) && !empty($categories)) || (isset($brands) && !empty($brands)) ? "col-lg-9" : "col-lg-12" ?>">
                            ...
                            <div class="row">
                                <?php foreach ($sub_categories as $key => $row) { ?>
                                    <div class="card col-md-2 col-sm-6 mr-2 mb-2 shadow-xl w-20">
                                        ...
                                        <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                                            <a href="<?= base_url('sellers/' . $seller_slug . '/products/category/' . html_escape($row->slug)) ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="">
                                            <div class="product-image item">
                                                <figure class="rounded">
                                                    <?php if($row['availability'] == 0) { ?>
                                                            <!-- <img class="pic-1 lazy fig_image w-100" src="<?= base_url('assets/front_end/modern/img/out_of_stock.jpg') ?>" style="object-fit: cover;"> -->
                                                            <div class="no-stock-container">
                                                                <img class="pic-1 lazy fig_image" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $row['image_sm'] ?>" style="object-fit: unset !important;">
                                                    ...
                                                    <?php } else { ?>
                                                            <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                                                                <a href="<?= base_url('sellers/' . $seller_slug . '/products/details/' . $row['slug']) ?>">
                                            ...
                                            " href="#" data-bs-toggle="white-tooltip" title="Add to wishlist" data-product-id="<?= $row['id'] ?>" style="color: <?= ($row['is_favorite'] == 1) ? 'red' : '' ?>">
                                                    ...
                                                    <?php } ?> -->
                                                    <?php if ($row['availability'] == '' || $row['availability'] == 1) { ?>
                                                        <span class="avatar sale_tag bg-pink d-flex position-absolute text-uppercase text-white">
                                                            <span class=""><?= !empty($this->lang->line('sale')) ? $this->lang->line('sale') : 'Sale'
                                                            ?></span>
                                                        </span>
                                    ...
                                    <div class="col-7 col-md-8">
                                        <div class="product-content product_listing_list">
                                            <h4 class="list-product-title title" title="<?= $row['name']; ?>">
                                                <?php if($row['availability'] == '' || $row['availability'] == 1) { ?>
                                                    <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                                                        <a class="text-decoration-none text-dark" href="<?= base_url('sellers/' . $row['seller_slug'] . '/products/details/' . $row['slug']) ?>">
                                    ...
                                    ?>
                                        <div class="project item col-6 col-xl-4 default-style my-2" title="<?= $row['name']; ?>">
                                            ...
                                            <div class="my-2 post-header">
                                                ...
                                                <h4 class="post-title" title="<?= $row['name']; ?>">
                                                    <?php if($row['availability'] == '' || $row['availability'] == 1) { ?>
                                                        <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                                                            <a href="<?= base_url('sellers/' . $row['seller_slug'] . '/products/details/' . $row['slug']) ?>" class="link-dark text-decoration-none"><?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['name']))), 15); ?></a>
                                                        <?php } else { ?>
                    ...
                    <?php if ((!isset($sub_categories) || empty($sub_categories)) && (!isset($products) || empty($products['product']))) { ?>
                        <div class="col-12 text-center">
                            ...
                            <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') { ?>
                                <a href="<?= base_url('sellers/' . $seller_slug . '/products') ?>" class="btn btn-sm rounded-pill btn-warning"><?= !empty($this->lang->line('go_to_shop')) ? $this->lang->line('go_to_shop') : 'Go to Shop' ?></a>
                            <?php } else { ?>
