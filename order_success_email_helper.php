...
function send_order_confirmation_seller_email($order_id) {
    ...
    foreach($seller_ids as $seller_id) {
        ...
        $to = $seller['email'];
        return send_mail($to,  $subject, $ci->load->view('admin/pages/view/order_placed_email_to_seller', $data, TRUE));
    }
}
...
function send_order_confirmation_admin_email($order_id) {
    ...
    foreach($system_user_permissions as $system_user_permission) {
        ...
        return send_mail($to,  $subject, $ci->load->view('admin/pages/view/order_placed_email_to_admin', $message, TRUE));
    }
}
