    ...
    <body style="background-color: #f8f9fa;">
        <div class="container my-5">
            <div class="card">
                ...
                <h4>ORDER ASSIGNED TO DELIVERY BOY</h4>
            </div> -->
                <div class="card-body">
                    <div class="row">
                    ...
                    <p>DEAR <strong><?= $delivery_man_name ?></strong>,</p>
                    <p>A new order from <?= $customer['username'] ?> has been assigned to you for delivery. Please find the order details below:</p>
                    ...
                    <p><a href="<?= $order_link ?>">View Order</a></p> -->
                    <p>THANKS REGARDS,</p>
