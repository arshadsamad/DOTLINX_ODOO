            ...
            <nav class="d-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 bg-transparent">
                    <li class="breadcrumb-item">
                        ...
                        <a href="<?= base_url() . 'sellers/' . $seller_slug ?>" class="text-decoration-none"><?= !empty($this->lang->line('seller_home')) ? $this->lang->line('seller_home') : 'Seller Home' ?></a>
                        <?php } else { ?>
                        <a href="<?= base_url() ?>" class="text-decoration-none"><?= !empty($this->lang->line('market')) ? $this->lang->line('market') : 'Market' ?></a>
                        <?php } ?>
                    </li>
...
<section class="wrapper bg-light">
    <div class="container pt-12 pt-md-14 mb-15">
        <form class="needs-validation" id="checkout_form" method="POST" action="
        <?php if(isset($seller_slug) && !empty($seller_slug) && $seller_slug != '') {
            echo base_url('sellers/' . $seller_slug . '/cart/place-order');
        } else {
            echo base_url('cart/place-order');
        }
        ?>">
                            ...
                            <div class="shipped-details mt-3 col-md-6">
                                <table class="table table-step-shipping">
                                    <tbody>
                                        ...
                                        <?php } ?>
                                        <?php if (isset($payment_methods['telr_payment_method']) && $payment_methods['telr_payment_method'] == 1) { ?>
                                        <tr>
                                            <td>
                                                <label for="telr">
                                                    <input id="telr" class="form-check-input" name="payment_method" type="radio" value="telr">
                                                </label>
                                            </td>
                                            <td>
                                                <label for="telr">
                                                    <img loading="lazy" src="<?= THEME_ASSETS_URL . 'img/payments/telr.jpg' ?>" class="payment-gateway-images" alt="telr" style="height: 30px;">
                                                </label>
                                            </td>
                                            <td>
                                                <label for="telr">
            ...
            <div class="modal-body">
                ...
                <section id="address_form">
                    ...
                    <div class="col-12 text-right mt-2">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#add-address-modal">
                            <?= !empty($this->lang->line('create_a_new_address')) ? $this->lang->line('create_a_new_address') : 'Create a New Address' ?>
                        </a>
                        <!-- <a target="_blank" href="<? //= base_url('my-account/manage-address')
                                                        ?>"><? //= !empty($this->lang->line('create_a_new_address')) ? $this->lang->line('create_a_new_address') : 'Create a New Address'
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="mobile_number_prefix">+971</span>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                            <label for="sub_state" class="control-label"><?= !empty($this->lang->line('sub_state')) ? $this->lang->line('sub_state') : 'Sub State' ?></label>
                            <select class="form-control" name="sub_state_id" id="sub_state_id">
                                <!-- dynamically write when state change -->
                            </select>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                            <label for="country" class="control-label"><?= !empty($this->lang->line('country')) ? $this->lang->line('country') : 'Country' ?></label>
                            <input type="text" class="form-control" name="country" id="country" placeholder="<?= !empty($this->lang->line('country')) ? $this->lang->line('country') : 'Country' ?>" readonly value="UAE" />
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
...
<iframe id="telr_frame" sandbox="allow-forms allow-modals allow-popups-to-escape-sandbox allow-popups allow-scripts allow-top-navigation allow-same-origin"></iframe>
