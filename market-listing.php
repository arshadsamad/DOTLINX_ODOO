        ...
        <div class="row align-items-center">
            ...
            <div class="swiper-container category-swiper" data-dots="true">
                <div class="swiper-wrapper swiper-slide-category">
                    ...
                    <?php foreach ($markets as $key => $row) { 
                        if($row['market_status'] == "1") { ?>
                        <div class="swiper-slide swiper-slide-category mx-2 pt-2 rounded <?php if($row['market_slug'] == $market_slug) echo "border border-3 border-grey px-2"; ?>">
...
<section class="container listing-page mb-15">
    <div class="product-listing card-solid py-4">
        <div class="row mx-0">
            ...
            <div class="border border-grey rounded mb-4">
                <h3 class='section-title text-center pt-2'><?= !empty($this->lang->line('markets')) ? $this->lang->line('markets') : $current_market . ' Sellers' ?></h3>
            </div>
            <div class="container-fluid filter-section pb-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="align-items-center d-flex flex-wrap justify-content-between gap-2">
                            ...
                            <div class="col-md-5 pl-0 d-none d-md-block">
                                ...
                                <input type="search" name="seller_search" class="form-control" id="seller_search_txt" value="<?= (isset($seller_search) && !empty($seller_search)) ? $seller_search : "" ?>" placeholder="<?= !empty($this->lang->line('search_seller')) ? $this->lang->line('search_seller') : 'Search Seller' ?>">
                            </div>
                ...
                <?php if (isset($sellers) && !empty($sellers)) { ?>
                                        ...
                                        <div class="align-items-center row d-flex">
                                                    ...
                                                    <div class="product-image">
                                                       <div class="product-image-container  product-sm-image-container">
                                                            <a href="<?= base_url('sellers/' . $row['slug']) ?>">
                                                                <img class="pic-1 mw-100 h-auto lazy blog-img" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $row['seller_profile'] ?>">
                                            ...
                                            <div class="col-lg-9 col-7">
                                                <div class="product-content">
                                                    <h3 class="list-product-title title fs-25 mt-4" title="<?= $row['seller_name'] ?>"><a href="<?= base_url('sellers/' . $row['slug']) ?>"><?= $row['seller_name'] ?></a></h3>
                                                    <div class="rating">
                                                    ...
                                                    <a href="<?= base_url('sellers/seller_details/' . $row['slug']) ?>" class="view-products  btn btn-sm btn-outline-primary rounded-pill my-2"><?= !empty($this->lang->line('about_seller')) ? $this->lang->line('about_seller') : 'About Seller' ?></a>
                                                    <a href="<?= base_url('sellers/'. $row['slug'] .'/products') ?>" class="view-products  btn btn-sm btn-outline-primary rounded-pill my-2"><?= !empty($this->lang->line('view_products')) ? $this->lang->line('view_products') : 'View Products' ?></a>
														 </div>
                                                </div>
                                            </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="row">
                            <?php foreach ($sellers as $row) { ?>
                                <div class="col-lg-4 col-md-6 mt-5" title="<?= $row['seller_name'] ?>">
